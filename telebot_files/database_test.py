...
testDatabase.insert_event("Hello Welfare", "2021/09/01", "2021/09/02", "2022/03/30", '15:30', '18:00', "You have been selected!",0)
testDatabase.insert_event("Giveaway Welfare", "2021/08/10", "2021/08/15", "2022/03/30", '15:30', '18:00', "You have been selected!",0)

## Sign up Welfare
testDatabase.insert_event("Sem 2 Welfare", "2021/12/10", "2022/03/30", "2022/05/20", '12:30', '13:30', "You have been selected!", 1)
testDatabase.insert_event("Recess Week Welfare", "2021/12/10", "2022/03/30", "2022/05/20", '15:30', '18:00', "You have been selected!",0)
...
print("Expected: Eliza Soh win_count increased to 2")
testDatabase.increase_wincount("1000000003")
testDatabase.query_user_details("1000000003")
print("==========================")
